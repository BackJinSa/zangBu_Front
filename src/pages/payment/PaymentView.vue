    ...
    <div class="mx-auto px-3 sm:px-4 max-w-4xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl">
      ...
      <div class="mt-4 sm:mt-6 bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4">
        ...
        <ul class="text-xs sm:text-sm text-blue-800 space-y-1">
          <li>• <strong>로그인 정보</strong>를 바탕으로 구매자 정보가 자동으로 입력됩니다.</li>
          <li>• 구매자 정보는 <strong>마이페이지</strong>에서 수정할 수 있습니다.</li>
          <li>
            • <strong>건당 결제</strong>는 부동산 분석 리포트를 1회 다운로드할 수 있는 상품입니다.
          </li>
          <li>
            • <strong>멤버십 플랜</strong>은 한 달간 무제한으로 리포트를 열람하고, 다양한 프리미엄
            기능을 이용할 수 있는 상품입니다.
          </li>
          <li>• 결제 버튼을 클릭하면 <strong>토스페이먼츠 결제창</strong>이 표시됩니다.</li>
          <li>
            • 모든 결제는 <strong>안전한 테스트 환경</strong>에서 진행되며, 실제 금액이 청구되지
            않습니다.
          </li>
          <li>
            • 결제 완료 후, 구매하신 상품에 따라 <strong>서비스 이용 권한</strong>이 즉시
            적용됩니다.
          </li>
        </ul>
      </div>
